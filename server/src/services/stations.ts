...
export const fallbackStations: RadioStation[] = [
    ...
    {
        name: 'Power FM',
        url: 'https://powerfm.listen.powerapp.com.tr/powerfm/mpeg/icecast.audio',
        homepage: 'https://www.powerfm.com.tr',
        favicon: 'https://www.powerfm.com.tr/favicon.ico',
        tags: ['pop', 'hits'],
        country: 'Turkey',
        language: 'turkish',
        codec: 'MP3',
    ...
    {
        name: 'Power Türk',
        url: 'https://powerturk.listen.powerapp.com.tr/powerturk/mpeg/icecast.audio',
        homepage: 'https://www.powerturk.com',
        favicon: 'https://www.powerturk.com/favicon.ico',
        tags: ['pop', 'turkish'],
        country: 'Turkey',
        language: 'turkish',
        codec: 'MP3',
    ...
    {
        name: 'Kral Pop',
        url: 'https://kralpop.listen.powerapp.com.tr/kralpop/mpeg/icecast.audio',
    ...
    // === УКРАИНА ===
    {
        ...
        favicon: 'https://www.hitfm.ua/favicon.ico',
        tags: ['pop', 'hits'],
        country: 'Ukraine',
        language: 'ukrainian',
        codec: 'MP3',
    ...
    },
    {
        ...
        favicon: 'https://www.radioroks.ua/favicon.ico',
        tags: ['rock'],
        country: 'Ukraine',
        language: 'ukrainian',
        codec: 'MP3',
    ...
    },
    {
        ...
        favicon: 'https://www.radiorelax.ua/favicon.ico',
        tags: ['relax', 'pop'],
        country: 'Ukraine',
        language: 'ukrainian',
        codec: 'MP3',
    ...
    // === КИТАЙ ===
    {
        name: 'Beijing Music Radio',
        url: 'http://l.cztvcloud.com/channels/lantian/fm974/128k.mp3',
        homepage: 'http://www.rbc.cn',
        favicon: 'http://www.rbc.cn/favicon.ico',
        tags: ['pop', 'music'],
        country: 'China',
        language: 'chinese',
        codec: 'MP3',
    ...
    {
        name: 'Amor 95.3',
        url: 'https://playerservices.streamtheworld.com/api/livestream-redirect/XHSH_FMAAC.aac',
        homepage: 'https://amor953.mx',
        favicon: 'https://amor953.mx/favicon.ico',
        tags: ['pop', 'romantic', 'spanish'],
        country: 'Mexico',
        language: 'spanish',
        codec: 'AAC',
        bitrate: 64,
    ...
    {
        name: 'Mix 106.5',
        url: 'https://playerservices.streamtheworld.com/api/livestream-redirect/XHDFM_FMAAC.aac',
        homepage: 'https://mix1065.mx',
        favicon: 'https://mix1065.mx/favicon.ico',
        tags: ['pop', 'english', '80s', '90s'],
        country: 'Mexico',
        language: 'spanish',
        codec: 'AAC',
        bitrate: 64,
    ...
    {
        name: 'Aspen 102.3',
        url: 'https://streaming.fmaspen.com/aspen',
        homepage: 'https://fmaspen.com',
        favicon: 'https://fmaspen.com/favicon.ico',
